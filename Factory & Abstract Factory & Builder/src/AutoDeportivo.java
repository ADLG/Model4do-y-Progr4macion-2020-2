...
/**
 * Clase que creara el Auto Deportivo predefinido.
 * @author Licona Gomez Aldo Daniel
 */
public class AutoDeportivo implements Auto
{
     ...
     * de un Auto Deportivo junto con su informacion.
     */
	...
	{
		armasstr = "Armas de tipo: METRALLETA";
		info.add(armasstr);
		armas.tipoDeArmas(5);
	...
	/**
     * Imprime las caracteristicas del Auto Deportivo.
     */
	@Override
	...
	/**
     * Imprime el tipo de partes elegidas para un Auto Deportivo.
     */
	public void partes()
	{
	...
	/**
     * Recibe las opciones para un Auto Deportivo.
     * @param opciones las opciones elegidas para un Auto Deportivo.
     */
	@Override
	...
	/**
     * Crea el Auto con las partes para un Auto Deportivo.
     */
	@Override
	public void crear()
	{
