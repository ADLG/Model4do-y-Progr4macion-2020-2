...
/**
 * Clase: CertificadoSinOpcionTecnica: esta clase tiene un unico
 ...
 * destacar que este metodo solo genera para alumnos sin opcion tecnica.
 */

public class CertificadoSinOpcionTecnica implements Certificados {
	 ...
	 * .txt el cual se llama CertificadoSinOpcionTecnica-NombreDelAlumno.txt
	 */
	public void generarCertificado(Alumno alumno, ArrayList<Profesor> arregloProfesores){
		...
		String certificado = String.format("*-------------------------------------------------------*\n"
										  ...
										  profesor1,profesor2,alumno.consultaPromedio());
		String nombreArchivo = String.format("CertificadoSinOpcionTecnica-%s.txt",alumno.getNombre());
